...
public class MySqlConnection implements DatabaseConnection{
    ...
    public void open() {
        ...
        try {
            ...
            Main.log.sendMessage(me.davidml16.baul.utils.Colorize.format("    &aMySQL has been enabled!"));

        } catch (HikariPool.PoolInitializationException | SQLException e) {

            Main.log.sendMessage(me.davidml16.baul.utils.Colorize.format("    &cMySQL has an error on the conection! Now trying with SQLite..."));
