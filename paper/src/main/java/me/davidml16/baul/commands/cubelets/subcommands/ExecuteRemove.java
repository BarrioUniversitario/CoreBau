        ...
        if(args.length == 3) {
            ...
            if(actualBalance >= 1) {
                 ...
                 CubeletsAPI.removeCubelet(player, id, 1);
                  ...
                  String msg = main.getLanguageHandler().getRawMessage("Commands.Cubelets.Remove.Removed");
                  msg = msg.replaceAll("%amount%", Integer.toString(amount));
                  msg = msg.replaceAll("%baul%",  main.getCubeletTypesHandler().getTypeBydId(id).getName());
                 ...
                 return true;
                     ...
                     String msg = main.getLanguageHandler().getRawMessage("Commands.Cubelets.Remove.NoBalance");
                     msg = msg.replaceAll("%amount%", Integer.toString(amount));
                     msg = msg.replaceAll("%baul%", Utils.removeColors(name));
