...
public class Sounds {
    public static void playSound(Location location, MySound mySound, float volume, float pitch) {
        try {
            location.getWorld()
                .playSound(location, mySound.bukkitSound(), volume, pitch);
    ...
    public enum MySound {
        ...
        WITCH_AMBIENT("WITCH_AMBIENT", "ENTITY_WITCH_AMBIENT"),
        ...
        /**
         * Get the bukkit sound for current server
         * version
         * <p>
         * Caches sound on first call
         *
         * @return corresponding
         *     {@link org.bukkit.Sound}
         */
        public org.bukkit.Sound bukkitSound() {
            ...
            for (String name : versionDependentNames) {
                try {
                    ...
                    IllegalArgumentException ignore2) {
                    // try next
                }
            }
