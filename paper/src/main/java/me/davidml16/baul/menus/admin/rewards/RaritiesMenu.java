...
import me.davidml16.baul.conversation.rarities.EditRarityConversation;
import me.davidml16.baul.conversation.rarities.RarityConversation;
...
public class RaritiesMenu extends Menu {
    ...
    public void OnPageOpened(int page) {
        ...
        Inventory gui = createInventory(45, "%baul_type% | Rarities".replaceAll("%baul_type%", id));
