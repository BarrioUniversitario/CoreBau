            ...
            for (Reward reward : rewards) {
                ...
                gui.addItem(new ItemBuilder(reward.getIcon().clone())
                        ...
                        .setLore(
                                ...
                                Utils.translate(" &7Cosmetics: &6" + reward.getCosmetics().size() + " "),
                                "",
                                ...
                                Utils.translate("&eDrop (Q) » &aEdit cosmetics "),
    ...
    public void OnMenuClick(InventoryClickEvent event) {
        ...
        if (slot == 18 && event.getCurrentItem().getType() == XMaterial.ENDER_PEARL.parseMaterial()) {
            ...
            if(event.getClick() == ClickType.LEFT) {
                ...
                EditRewardCosmeticsMenu editRewardCosmeticsMenu = new EditRewardCosmeticsMenu(getMain(), player);
                editRewardCosmeticsMenu.setAttribute(AttrType.REWARD_ATTR, reward);
                editRewardCosmeticsMenu.open();
