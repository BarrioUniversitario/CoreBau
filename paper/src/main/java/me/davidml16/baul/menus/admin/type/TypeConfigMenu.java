...
import me.davidml16.baul.menus.admin.AnimationsMenu;
import me.davidml16.baul.menus.admin.rewards.RaritiesMenu;
...
public class TypeConfigMenu extends Menu {
    ...
    public void OnPageOpened(int page) {
        ...
        Inventory gui = createInventory(45, "%baul_type% | Configuration".replaceAll("%baul_type%", id));
