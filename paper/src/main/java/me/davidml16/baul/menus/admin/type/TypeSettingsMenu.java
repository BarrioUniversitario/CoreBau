package me.davidml16.baul.menus.admin.type;

import com.cryptomorin.xseries.XMaterial;
import me.davidml16.baul.Main;
import me.davidml16.baul.conversation.RenameConversation;
import me.davidml16.baul.conversation.TypeIconConversation;
import me.davidml16.baul.conversation.TypeKeyConversation;
...
public class TypeSettingsMenu extends Menu {
    ...
    public void OnPageOpened(int page) {
        ...
        Inventory gui = createInventory(45, "%baul_type% | Settings".replaceAll("%baul_type%", id));
