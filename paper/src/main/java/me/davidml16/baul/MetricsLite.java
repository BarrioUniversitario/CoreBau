...
public class MetricsLite {
    ...
    static {
        ...
        if (System.getProperty("bstats.relocatecheck") == null
            ...
            // package names
            if (me.davidml16.baul.MetricsLite.class.getPackage().getName().equals(defaultPackage)
                    || me.davidml16.baul.MetricsLite.class.getPackage().getName().equals(examplePackage)) {
    ...
    public MetricsLite(Plugin plugin, int pluginId) {
        ...
        if (enabled) {
            ...
            Bukkit.getServicesManager().register(me.davidml16.baul.MetricsLite.class, this, plugin, ServicePriority.Normal);
            if (!found) {
                // We are the first!
                startSubmitting();
            }
