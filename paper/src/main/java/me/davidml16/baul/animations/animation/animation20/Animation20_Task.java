package me.davidml16.baul.animations.animation.animation20;
...
import me.davidml16.baul.animations.FakeBlock;
...
public class Animation20_Task extends Animation {
	...
	public void onTick(int time) {
		...
		if (time == 50) {
			...
			enderman.setMetadata("BAUL", new FixedMetadataValue(getMain(), Boolean.TRUE));
