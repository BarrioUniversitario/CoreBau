package me.davidml16.baul.animations.animation.animation13;
...
import me.davidml16.baul.utils.Version;
...
public class Animation13_Gwen extends BukkitRunnable {
	...
	public Animation13_Gwen(Main main, Entity target, Location center, float radius, int points, int step) {
		...
		guardian.setMetadata("BAUL", new FixedMetadataValue(main, Boolean.TRUE));
